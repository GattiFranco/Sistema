...
CREATE TABLE `usuariorol` (
  ...
  `permisorol` varchar(255) DEFAULT NULL,
  `usuarioid` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `usuarioid` (`usuarioid`),
  CONSTRAINT `usuariorol_ibfk_1` FOREIGN KEY (`usuarioid`) REFERENCES `usuario` (`id`)
...
INSERT INTO `usuariorol` VALUES (1,'Admin','Todos los permisos',1);
